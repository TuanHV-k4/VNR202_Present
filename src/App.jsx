    ...
    <main className="story-main" data-page={page} style={{transform:`translate3d(0, -${page * 100}svh, 0)`}}>
      ...
      <section className="answer-section story-page" aria-labelledby="answer-title">
        ...
        <div className="argument-axis" aria-label="Ba tầng chứng cứ lịch sử">
          <article><div className="argument-date"><b>1939—1940</b><span>Chọn đúng hướng rèn</span></div><div><h3>Chuẩn bị về chiến lược trước khi thời cơ xuất hiện</h3><p>Hội nghị Trung ương 6 tháng 11/1939 đặt nhiệm vụ giải phóng dân tộc lên hàng đầu, tạm gác khẩu hiệu cách mạng ruộng đất và chủ trương xây dựng Mặt trận dân tộc thống nhất phản đế Đông Dương. Bắc Sơn và Nam Kỳ tuy chưa thành công trọn vẹn nhưng để lại kinh nghiệm đấu tranh vũ trang cùng nòng cốt lực lượng đầu tiên.</p><strong>Ngay trong lúc tình thế đen tối nhất, hướng đi đã được chọn. Chứng cứ này bác bỏ ý nghĩ rằng cách mạng chỉ bắt đầu chuẩn bị sau khi Nhật đầu hàng.</strong></div></article>
